...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call double @toRadians(double 9.000000e+01)
...
; Function Attrs: nounwind
define internal double @toRadians(double %degrees) #0 {
  %1 = alloca double, align 8
  store double %degrees, double* %1, align 8
  %2 = load double* %1, align 8
  %3 = fmul double %2, 0x400921FB5A7ED197
